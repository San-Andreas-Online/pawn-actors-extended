# Contributing to Actors Extended functions
...
- [Contributing to Actors Extended functions](#contributing-to-actors-extended-functions)
...
```bat
cd %userprofile%\Documents\Projects\pawn-actors-extended\
```

On Linux:

```bash
cd ~/pawn-actors-extended/
```

Clone via SSH:  

```bash
git clone git@github.com:San-Andreas-Online/pawn-actors-extended.git
```

Clone via HTTPS

```bash
git clone https://github.com/San-Andreas-Online/pawn-actors-extended.git
```
